...
//const maxVersion = 'v14.4.1';
//const edgeBranch = 'development';
const githubRepo = 'https://github.com/fknaopen/Tasmota.git';
const minVersion = 'v9.3.0';
const maxVersion = 'v9.5.0';
const edgeBranch = 'dev_webcamtweaks2024';
